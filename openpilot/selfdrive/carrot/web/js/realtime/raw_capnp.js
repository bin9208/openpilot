  ...
  const HUD_SCHEMAS = {
    ...
    carrotMan: {
      fields: {
        ...
        vehicleNaviActive: { kind: "bool", offset: 640 },
        vehicleNaviSpeed: { kind: "int32", offset: 21 },
        vehicleNaviSectionActive: { kind: "bool", offset: 641 },
        vehicleNaviAvailable: { kind: "bool", offset: 642 },
        naviOwner: { kind: "text", offset: 9 },
        naviSessionId: { kind: "text", offset: 10 },
        naviSequence: { kind: "uint64", offset: 11 },
        naviOwnerAgeMs: { kind: "int32", offset: 24 },
        naviSafetyAgeMs: { kind: "int32", offset: 25 },
        naviLifecycle: { kind: "text", offset: 11 },
        naviControlAllowed: { kind: "bool", offset: 643 },
