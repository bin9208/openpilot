...
def enable_auto_log_upload(started, params, CP: car.CarParams) -> bool:
  return params.get_bool("AutoLogUpload")
...
procs = [
  ...
  PythonProcess("uploader", "system.loggerd.uploader", enable_auto_log_upload),
